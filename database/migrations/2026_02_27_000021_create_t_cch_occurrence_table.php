 ...
 * Conditional fields berdasarkan defect_made_by:
 *   Own_plant/Sanoh_group → responsible_plant_id, process_id
 *   Supplier              → supplier_id, supplier_process_id
...
return new class extends Migration
{
    ...
    {
        // Block 8 - Occurrence Header
        Schema::create('t_cch_occurrence', function (Blueprint $table) {
        ...
        // Block 8 - Occurrence Causes (multiple rows)
        Schema::create('t_cch_occurrence_causes', function (Blueprint $table) {
            $table->id('occ_cause_id');
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('t_cch_occurrence');
    }
};
