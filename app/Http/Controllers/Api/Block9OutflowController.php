...
class Block9OutflowController extends Controller
{
    public function show($id): JsonResponse
    {
        ...
        if (!$outflow) {
            return response()->json(['success' => false, 'message' => 'Block 9 not found'], 404);
        }

        return response()->json(['success' => true, 'data' => $outflow]);
    }
    ...
    public function update(Request $request, $id): JsonResponse
    {
        ...
        if ($error = WorkflowService::checkBlockAccess($cch, $sphereUser, 9)) {
