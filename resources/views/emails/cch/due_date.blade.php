...
<title>Email Notifikasi CCH – CCH Sanoh Indonesia</title>
...
<div class="email-wrapper" style="max-width: 600px; margin: 0 auto;">
  <div class="email-doc" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.10);">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td valign="middle" style="padding-right: 12px;">
                      <div style="width: 44px; height: 44px; background-color: #1e3556; border-radius: 8px; text-align: center; line-height: 44px; font-size: 11px; font-weight: 700; color: #c9a030; letter-spacing: 0.04em; border: 1px solid rgba(201,160,48,0.3); box-sizing: border-box;">CCH</div>
                    </td>
                    <td valign="middle">
                      <div style="font-size: 14px; font-weight: 700; color: #ffffff; letter-spacing: 0.01em; line-height: 1.2;">CCH Sanoh Indonesia</div>
              ...
              <td valign="middle" align="right" style="text-align: right;">
                <div style="font-size: 10px; font-family: 'IBM Plex Mono', monospace; color: rgba(255,255,255,0.4); margin-bottom: 3px;">Notif. DUE-DATE-REMINDER</div>
          ...
          <table border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td valign="middle" style="padding-right: 10px;">
                <div style="background-color: #0f1e35; color: #c9a030; border: 1px solid rgba(201,160,48,0.25); padding: 4px 12px; border-radius: 4px; font-size: 11px; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; display: inline-block; white-space: nowrap;">⚠️ Reminder</div>
              </td>
              <td valign="middle">
                <div style="font-size: 12.5px; color: #6b7c93;">Jatuh tempo pengisian block</div>
              </td>
            </tr>
          </table>
        </td>
    ...
    <div class="body">
      ...
      <div class="salutation">Kepada Yth. <strong>Admin PIC</strong>,</div>

      <div class="headline">Reminder Pengisian<br>Block Occurrence & Outflow</div>

      <div class="body-para">
        Anda memiliki request pengisian analisis CCH yang 
        @if($daysDiff < 0)
        <strong>telah melewati batas waktu (Overdue)</strong>.
        @elseif($daysDiff === 0)
        <strong>jatuh tempo hari ini</strong>.
        @else
        akan jatuh tempo dalam <strong>{{ $daysDiff }} hari</strong>.
        @endif
        Harap segera menyelesaikan pengisian pada Block Occurrence & Outflow untuk nomor CCH berikut:
      </div>
      ...
      <table class="detail-table">
        ...
        <tbody>
          ...
          <tr>
            <td class="td-label">Status Reminder</td>
            <td class="td-value">{{ $statusLabel }}</td>
          </tr>
          <tr>
            <td class="td-label">Batas Waktu (Due Date)</td>
            <td class="td-value">{{ $dueDate }}</td>
          </tr>
        </tbody>
      </table>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 24px;">
        <tr>
          <td style="border-left: 4px solid #dc2626; padding: 12px 16px; font-size: 13px; color: #dc2626; font-weight: 600; background-color: transparent;">
            ⚠️ Request pengisian analisis telah jatuh tempo atau overdue.
          </td>
        </tr>
      </table>
      @endif
      ...
      <div class="cta-section">
        <a href="{{ $cchUrl }}" class="btn-primary">Isi Block Occurrence</a>
      </div>

      <!-- Footer note -->
      <div class="footer-note">
        Email ini dikirim secara otomatis oleh sistem CCH CCH Sanoh Indonesia.<br>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td style="font-size: 10.5px; color: rgba(255,255,255,0.25); line-height: 1.6;">
                <span style="color: #c9a030; font-weight: 600;">CCH Sanoh Indonesia</span> · Sistem Notifikasi CCH<br>
                © {{ now()->year }} CCH Sanoh Indonesia. Seluruh hak dilindungi.
              </td>
            </tr>
          </table>
        </td>
